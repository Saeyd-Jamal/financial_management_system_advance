...
class ReportController extends Controller
{
    ...
    public function export(Request $request){
        ...
        if($request->report_type == 'salaries'){
            ...
            if($request->export_type == 'view'){
                $pdf = PDF::loadView('dashboard.reports.salaries',['salaries' =>  $salaries,'salariesTotalArray' => $salariesTotalArray,'month' => $request->month,'USD' => $USD,'filter' => $request->all()],[],
                [
                    'mode' => 'utf-8',
                    'format' => $type_print,
        ...
        if($request->report_type == 'customization'){
            ...
            if($request->export_type == 'view'){
                $pdf = PDF::loadView('dashboard.reports.customization',['salaries' =>  $salaries,'salariesTotalArray' => $salariesTotalArray,'workplaces' => $workplaces,'month' => $request->month,'USD' => $USD,'filter' => $request->all()],[],
                [
                    'mode' => 'utf-8',
                    'format' => $type_print,
                    'default_font' => 'Arial',
