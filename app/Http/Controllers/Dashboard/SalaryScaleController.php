...
class SalaryScaleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.pages.salary_scales', compact('salary_scales','salary_scales_basic'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            DB::commit();
            return redirect()->route('dashboard.salary_scales.index')->with('success', 'تم إضافة سلم الرواتب');
        }catch(Throwable $e){
            DB::rollBack();
    ...
    {
        $this->authorize('update', SalaryScale::class);
