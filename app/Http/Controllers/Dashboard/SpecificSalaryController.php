...
class SpecificSalaryController extends Controller
{
    ...
    public function ratioCreate(Request $request){
        ...
        return redirect()->route('dashboard.specific_salaries.ratio')->with('success', 'تم إعداد الراتب للموظفين النسبة');
    }
    ...
    public function privateCreate(Request $request){
        ...
        return redirect()->route('dashboard.specific_salaries.index')->with('success', 'تم إعداد الراتب للموظفين الخاص');
    }
    ...
    public function riyadhCreate(Request $request){
        ...
        return redirect()->route('dashboard.specific_salaries.index')->with('success', 'تم إعداد الراتب لموظفين الرياض');
    }
    ...
    public function fasleCreate(Request $request){
        ...
        return redirect()->route('dashboard.specific_salaries.index')->with('success', 'تم إعداد الراتب لموظفين الفصلي');
    }
    ...
    public function interimCreate(Request $request){
        ...
        return redirect()->route('dashboard.specific_salaries.index')->with('success', 'تم إعداد الراتب لموظفين المؤقتين');
    }
    ...
    public function dailyCreate(Request $request){
        ...
        return redirect()->route('dashboard.specific_salaries.index')->with('success', 'تم إعداد الراتب للموظفين اليوميين');
    }
}
