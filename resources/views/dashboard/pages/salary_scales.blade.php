    ...
    <div class="row justify-content-center">
        <div class="col-12">
            <div class="row align-items-center mb-2">
                ...
                <div class="col-auto">
                    @can('update', 'App\\Models\SalaryScale')
                    <a type="button" class="btn btn-info text-white" data-bs-toggle="modal" data-bs-target="#editItem">
                        <i class="fa-solid fa-edit f-16"></i>
                    </a>
                    @endcan
                </div>
            </div>
        ...
        <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('dashboard.salary_scales.store')}}" method="post" class="col-12">
                        @csrf
                        <div class="row">
    ...
    <div class="modal fade" id="editItem" tabindex="-1" role="dialog" aria-labelledby="editItemLabel" aria-hidden="true">
        <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('dashboard.salary_scales.update',$salary_scales_basic->id)}}" method="post" class="col-12">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="input-group mb-3">
